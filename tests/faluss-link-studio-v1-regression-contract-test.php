...
studio_v1_regression_assert( false !== strpos( $bootstrap, 'Version: 0.3.21' ) && false !== strpos( $bootstrap, "FALUSS_LINK_VERSION','0.3.21'" ), 'The Studio regression patch must remain active under Faluss Link 0.3.21.' );
