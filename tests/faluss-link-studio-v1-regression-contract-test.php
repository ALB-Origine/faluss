...
studio_v1_regression_assert( false !== strpos( $bootstrap, 'Version: 0.3.12' ) && false !== strpos( $bootstrap, "FALUSS_LINK_VERSION','0.3.12'" ), 'The Studio regression patch must rotate Faluss Link assets to 0.3.12.' );
