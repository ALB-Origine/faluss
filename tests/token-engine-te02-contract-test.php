...
foreach ( array( 'connector_client_id', 'connector_secret_hash', 'connector_secret_version', 'connector_permissions', 'connector_client_id_unique', 'token_engine_connector_tokens', 'token_hash_unique', 'token_project_expires', 'migrate_v1_to_v2', "const VERSION = '3'", "const V2_VERSION = '2'", "const LEGACY_VERSION = '1'", 'ALTER TABLE' ) as $needle ) {
...
te02_assert( 9 === substr_count( $access, 'register_rest_route' ), 'EC-02 exposes nine bounded, private connector routes.' );
