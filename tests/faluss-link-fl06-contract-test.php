...
foreach(array('faluss-link-card--align-center .faluss-link-card__avatar','faluss-link-card--align-center .faluss-link-card__availability','faluss-link-card--align-center .faluss-link-card__social','faluss-link-card--align-center .faluss-link-card__links') as $needle)fl06_assert(false!==strpos($immersive.$studio,$needle),'Center alignment is incomplete: '.$needle);
