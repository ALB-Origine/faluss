...
studio_v1_polish_assert( false !== strpos( $bootstrap, 'Version: 0.3.19' ) && false !== strpos( $bootstrap, "FALUSS_LINK_VERSION','0.3.19'" ), 'The Studio interaction patch must retain the current Faluss Link asset version.' );
