...
foreach ( array( 'body.faluss-identity-public-route > .faluss-identity-public-header-layer', 'position: absolute;', 'overflow: visible;', 'body.faluss-identity-public-route > .faluss-identity-profile-page', 'margin: 0;' ) as $needle ) { fl13_assert( false !== strpos( $immersive, $needle ), 'The public shell must overlay the header without a pre-hero gap: ' . $needle ); }
