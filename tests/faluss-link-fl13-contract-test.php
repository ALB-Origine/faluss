...
foreach ( array( 'body.faluss-identity-public-route > .elementor-location-header', 'position: absolute;', 'z-index: 10;', 'body.faluss-identity-public-route > .faluss-identity-profile-page', 'margin: 0;' ) as $needle ) { fl13_assert( false !== strpos( $immersive, $needle ), 'The isolated public shell must overlay the header without a pre-hero gap: ' . $needle ); }
