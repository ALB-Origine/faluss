...
fi06_onboarding_assert( false !== strpos( $link, 'Faluss_Identity_Onboarding::onboarding_completion_destination()' ), 'Card publication returns through the shared internal onboarding continuation.' );
