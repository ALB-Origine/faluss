...
onb025_assert( false !== strpos( $bootstrap, 'Version: 0.3.15' ) && false !== strpos( $bootstrap, "FALUSS_LINK_VERSION','0.3.15'" ), 'The current viewport assets need a renewable plugin version.' );
