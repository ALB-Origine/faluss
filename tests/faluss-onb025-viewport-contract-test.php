...
onb025_assert( false !== strpos( $bootstrap, 'Version: 0.3.11' ) && false !== strpos( $bootstrap, "FALUSS_LINK_VERSION','0.3.11'" ), 'The current viewport assets need a renewable plugin version.' );
