...
require_once $root . '/plugins/faluss-federation/includes/class-faluss-federation-providers.php';
...
$request_schema = json_decode( file_get_contents( $root . '/contracts/faluss-federation-request.schema.json' ), true ); $acceptance_schema = json_decode( file_get_contents( $root . '/contracts/faluss-event-acceptance.schema.json' ), true );
...
$workers_source = file_get_contents( $root . '/plugins/faluss-events/includes/class-faluss-events-workers.php' ); $server_source = file_get_contents( $root . '/plugins/faluss-federation/includes/class-faluss-federation-server.php' ); $federation_schema_source = file_get_contents( $root . '/plugins/faluss-federation/includes/class-faluss-federation-schema.php' );
