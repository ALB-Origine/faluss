...
cap01b2_assert( false !== strpos( file_get_contents( $paths['registry_bootstrap'] ), 'Version: 0.2.0' ) && false !== strpos( file_get_contents( $paths['identity_bootstrap'] ), 'Version: 0.5.3' ) && false !== strpos( file_get_contents( $paths['portal_bootstrap'] ), 'Version: 0.1.23' ), 'Apps Registry and Identity Client remain fixed while Portal advances to AN-01B.2.' );
cap01b2_assert( false !== strpos( file_get_contents( $paths['federation_bootstrap'] ), 'Version: 0.3.0' ) && false !== strpos( file_get_contents( $paths['link_bootstrap'] ), 'Version: 0.3.20' ) && false !== strpos( file_get_contents( $paths['identity_bootstrap_owner'] ), 'Version: 0.4.15' ), 'Federation and Identity remain fixed while Link advances to AN-01B.2.' );
