...
cap01b2_assert( false !== strpos( file_get_contents( $paths['federation_bootstrap'] ), 'Version: 0.1.9' ) && false !== strpos( file_get_contents( $paths['link_bootstrap'] ), 'Version: 0.3.19' ) && false !== strpos( file_get_contents( $paths['identity_bootstrap_owner'] ), 'Version: 0.4.15' ), 'Federation, Link and Identity must remain unchanged.' );
