...
cap01b2_assert( false !== strpos( file_get_contents( $paths['registry_bootstrap'] ), 'Version: 0.2.0' ) && false !== strpos( file_get_contents( $paths['identity_bootstrap'] ), 'Version: 0.5.3' ) && false !== strpos( file_get_contents( $paths['portal_bootstrap'] ), 'Version: 0.1.22' ), 'The three CAP-01B.2 plugin versions must advance exactly.' );
cap01b2_assert( false !== strpos( file_get_contents( $paths['federation_bootstrap'] ), 'Version: 0.2.0' ) && false !== strpos( file_get_contents( $paths['link_bootstrap'] ), 'Version: 0.3.19' ) && false !== strpos( file_get_contents( $paths['identity_bootstrap_owner'] ), 'Version: 0.4.15' ), 'Federation may advance only to EVT-01B.1; Link and Identity remain unchanged.' );
