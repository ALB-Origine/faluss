...
fi02_passwordless_assert( false !== strpos( $bootstrap, "FALUSS_IDENTITY_VERSION', '0.4.12" ) && false !== strpos( $source, 'FALUSS_IDENTITY_VERSION' ), 'The corrected frontend asset is versioned from the plugin source.' );
