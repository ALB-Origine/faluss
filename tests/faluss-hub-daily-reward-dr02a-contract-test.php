...
foreach ( array( "FALUSS_PORTAL_VERSION', '0.1.24'", "TOKEN_ENGINE_VERSION', '0.4.1'", "const VERSION = '5'" ) as $needle ) {
    dr02a_assert( false !== strpos( $bootstrap . $token_bootstrap . $token_schema, $needle ), 'DR-02A.1 must remain present under Portal 0.1.24 with Token Engine 0.4.1 schema 5: ' . $needle );
}
