...
foreach(array('data-fl-tab="profile"','data-fl-tab="links"','data-fl-tab="style"','aria-selected','aria-controls','aria-labelledby','ArrowLeft','ArrowRight','Home','End') as $needle)fl03_assert(false!==strpos($js.$source,$needle),'Missing accessible Profil/Liens/Style switcher behavior: '.$needle);
