...
$fresh_requires_onboarding = onb01_private( 'requires_onboarding', false, array( 'choice' => 'unknown' ) );
$complete_requires_onboarding = onb01_private( 'requires_onboarding', false, array( 'choice' => 'no_card' ) );
onb01_assert( true === $fresh_requires_onboarding && false === $complete_requires_onboarding, 'Only a fresh or undecided member is intercepted by onboarding.' );
