...
fl_hotfix_assert( false !== strpos( $link_bootstrap, "FALUSS_LINK_VERSION','0.3.21'" ) && false !== strpos( $identity_bootstrap, "FALUSS_IDENTITY_VERSION', '0.4.15'" ) && false !== strpos( $portal_bootstrap, "FALUSS_PORTAL_VERSION', '0.1.24'" ), 'FL-HOTFIX-01.3 behavior must remain present while Link and Portal advance independently.' );
