...
fl_hotfix_assert( false !== strpos( $link_bootstrap, "FALUSS_LINK_VERSION','0.3.18'" ) && false !== strpos( $identity_bootstrap, "FALUSS_IDENTITY_VERSION', '0.4.15'" ) && false !== strpos( $portal_bootstrap, "FALUSS_PORTAL_VERSION', '0.1.20'" ), 'FL-HOTFIX-01.3 must preserve the expected Link and Identity versions while Portal advances independently.' );
