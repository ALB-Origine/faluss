...
fed01b3_assert( '0.1.6' === FALUSS_FEDERATION_VERSION, 'Federation version must be 0.1.6.' );
...
$crypto_source = file_get_contents( dirname( __DIR__ ) . '/plugins/faluss-federation/includes/class-faluss-federation-crypto.php' );
