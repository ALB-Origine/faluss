...
fl182_assert( false !== strpos( $identity, '<div class="faluss-identity-public-header-layer">' ) && false !== strpos( $identity, '<main class="faluss-identity-profile-page' ) && strpos( $identity, '<div class="faluss-identity-public-header-layer">' ) > strpos( $identity, 'self::render_elementor_template( self::get_template_id() )' ), 'The route-only public shell must retain separate header and profile siblings with the header after the card in DOM order.' );
fl182_assert( false !== strpos( $immersive, "body.faluss-identity-public-route > .faluss-identity-public-header-layer,\nbody.faluss-identity-public-route > .elementor-location-header" ) && false !== strpos( $immersive, 'position: absolute;') && false !== strpos( $immersive, 'overflow: visible;'), 'The header plane must overlay the immersive route without changing Elementor itself.' );
fl182_assert( false !== strpos( $immersive, 'body.faluss-identity-public-route > .faluss-identity-profile-page') && false !== strpos( $immersive, 'position: relative;') && false !== strpos( $immersive, 'overflow: visible;'), 'The card plane must remain below the header and never clip an Elementor sidebar.' );
