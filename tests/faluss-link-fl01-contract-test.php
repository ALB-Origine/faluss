...
foreach(array('faluss-link-card--cover-','faluss-link-card--avatar-','card_markup','cover > 0','avatar_visible') as $s)fl_assert(false!==strpos($source,$s),'Missing card composition branch: '.$s);
