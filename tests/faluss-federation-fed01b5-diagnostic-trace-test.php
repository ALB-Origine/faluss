...
$server_path = $root . '/plugins/faluss-federation/includes/class-faluss-federation-server.php';
$client_path = $root . '/plugins/faluss-federation/includes/class-faluss-federation-client.php';
