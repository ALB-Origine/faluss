...
foreach ( array( 'body.faluss-identity-public-route > .faluss-identity-public-header-layer', 'body.faluss-identity-public-route > .elementor-location-header', 'position: absolute;', 'padding-top: env(safe-area-inset-top, 0px)', 'pointer-events: auto;', 'z-index: 1;' ) as $needle ) { fl14_assert( false !== strpos( $immersive, $needle ), 'The transparent header must remain over the hero with safe interactive content: ' . $needle ); }
