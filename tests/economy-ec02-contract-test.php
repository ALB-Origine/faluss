...
foreach ( array( "const VERSION = '5'", "const V4_VERSION = '4'", "const V3_VERSION = '3'", 'token_engine_entitlement_definitions', 'token_engine_entitlement_grants', 'ENGINE=InnoDB', 'entitlement_code_unique', 'grant_operation_unique', 'migrate_v2_to_v3', 'current_schema_ready' ) as $needle ) {
