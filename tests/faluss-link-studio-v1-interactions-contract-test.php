...
studio_v1_interactions_assert( false !== strpos( $bootstrap, 'Version: 0.3.21' ) && false !== strpos( $bootstrap, "FALUSS_LINK_VERSION','0.3.21'" ), 'The interaction assets must use the current 0.3.21 cache key.' );
...
studio_v1_interactions_assert( false !== strpos( $studio, 'flex: 0 0 36px') && false !== strpos( $studio, 'width: 36px; height: 36px') && false !== strpos( $studio, 'width: 16px; height: 16px'), 'The social add control must keep a compact 36px target around a 16px visual bubble.' );
...
studio_v1_interactions_assert( false !== strpos( $studio, 'faluss-link-studio__ecosystem-lead' ) && false !== strpos( $studio, 'faluss-link-studio__ecosystem-products' ) && false !== strpos( $studio, 'faluss-link-studio__ecosystem-actions' ), 'Ecosystem cards and authenticated actions must use the responsive two-column layout.' );
