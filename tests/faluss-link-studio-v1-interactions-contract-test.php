...
studio_v1_interactions_assert( false !== strpos( $bootstrap, 'Version: 0.3.11' ) && false !== strpos( $bootstrap, "FALUSS_LINK_VERSION','0.3.11'" ), 'The interaction assets must use the 0.3.11 cache key.' );
