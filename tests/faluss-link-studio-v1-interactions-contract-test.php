...
studio_v1_interactions_assert( false !== strpos( $bootstrap, 'Version: 0.3.20' ) && false !== strpos( $bootstrap, "FALUSS_LINK_VERSION','0.3.20'" ), 'The interaction assets must use the current 0.3.20 cache key.' );
