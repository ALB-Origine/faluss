...
onb023_assert( false !== strpos( $bootstrap, 'Version: 0.3.18' ) && false !== strpos( $bootstrap, "FALUSS_LINK_VERSION','0.3.18'" ), 'The current Faluss Link frontend assets require a fresh plugin version.' );
