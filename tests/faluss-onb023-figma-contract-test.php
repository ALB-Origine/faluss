...
onb023_assert( false !== strpos( $bootstrap, 'Version: 0.3.21' ) && false !== strpos( $bootstrap, "FALUSS_LINK_VERSION','0.3.21'" ), 'The current Faluss Link frontend assets require the current plugin version.' );
