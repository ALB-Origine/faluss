...
onb023_assert( false !== strpos( $bootstrap, 'Version: 0.3.6' ) && false !== strpos( $bootstrap, "FALUSS_LINK_VERSION','0.3.6'" ), 'The corrected Figma viewport assets require a fresh Faluss Link asset version.' );
