...
onb022_assert( false !== strpos( $bootstrap, 'Version: 0.3.8' ) && false !== strpos( $bootstrap, "FALUSS_LINK_VERSION','0.3.8'" ), 'The asset cache key must include the current Faluss Link frontend assets.' );
