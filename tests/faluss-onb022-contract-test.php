...
onb022_assert( false !== strpos( $bootstrap, 'Version: 0.3.6' ) && false !== strpos( $bootstrap, "FALUSS_LINK_VERSION','0.3.6'" ), 'The asset cache key must change with the corrected Figma ONB-02 viewport assets.' );
