...
evt01b1_assert( false !== strpos( $bootstrap, 'Version: 0.3.0' ) && false !== strpos( $bootstrap, "FALUSS_FEDERATION_SCHEMA_VERSION', '1'" ) && false !== strpos( $events_bootstrap, 'Version: 0.3.1' ) && false !== strpos( $events_bootstrap, "FALUSS_EVENTS_SCHEMA_VERSION', '2'" ), 'Versions must be Events 0.3.1/schema 2 and Federation 0.3.0/schema 1.' );
Faluss_Events::boot();
