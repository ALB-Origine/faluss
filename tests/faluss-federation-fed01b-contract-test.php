...
fed01b_contains_all( $bootstrap, array( 'Version: 0.1.4', "FALUSS_FEDERATION_VERSION', '0.1.4'", 'Requires at least: 6.4', 'Requires PHP: 7.4', "FALUSS_FEDERATION_SCHEMA_VERSION', '1'" ), 'bootstrap' );
...
fed01b_contains_all( $server, array( "'POST'", "'/exchange'", 'MAX_BODY = 65536', 'JSON_THROW_ON_ERROR', 'request_canonical', 'consume_replay_and_limit', 'get_header_as_array', 'serve_pre_serialized', 'X-Faluss-Federation-Signature', 'private, no-store' ), 'receiver' );
