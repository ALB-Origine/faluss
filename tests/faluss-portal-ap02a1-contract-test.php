...
ap02a1_assert( false !== strpos( $bootstrap, "FALUSS_PORTAL_VERSION', '0.1.24'" ) && false === strpos( $portal, 'token_engine_pf_ledger' ) && false === strpos( $portal, 'dbDelta' ) && false === strpos( $portal, 'CREATE TABLE' ), 'DR-02A.1 must remain present without adding a ledger, migration or table.' );
