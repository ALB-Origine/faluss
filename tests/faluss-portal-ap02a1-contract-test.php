...
foreach ( array( 'appearance: none', 'margin: 0', 'border: 0 !important', 'outline: 0 !important', 'cursor: pointer' ) as $needle ) {
...
ap02a1_assert( false !== strpos( $bootstrap, "FALUSS_PORTAL_VERSION', '0.1.19'" ) && false === strpos( $portal, 'token_engine_pf_ledger' ) && false === strpos( $portal, 'dbDelta' ) && false === strpos( $portal, 'CREATE TABLE' ), 'AP-02A.2 must only version Portal and must not add a ledger, migration or table.' );
