...
foreach(array('networkAsset','networkIcon','aria-label', 'faluss-link-card--avatar-yes', 'faluss-link-card--avatar-no', 'function updateLinks', "rel: 'noopener noreferrer nofollow'") as $needle)fl02_assert(false!==strpos($js,$needle),'Missing complete live-preview synchronization: '.$needle);
