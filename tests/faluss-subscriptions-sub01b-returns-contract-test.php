...
sub01b_returns_assert( false === stripos( $returns_source, '<!doctype' ) && false === strpos( $returns_source, 'Faluss_Subscriptions_Entitlements::' ), 'The return controller must not render a standalone page or grant rights.' );
