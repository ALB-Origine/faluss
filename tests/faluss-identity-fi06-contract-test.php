...
$preferences = file_get_contents( $root . '/plugins/faluss-identity/includes/class-faluss-identity-front-preferences.php' );
...
require_once $root . '/plugins/faluss-identity/includes/class-faluss-identity-front-preferences.php';
