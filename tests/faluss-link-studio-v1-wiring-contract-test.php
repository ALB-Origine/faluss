...
studio_v1_wiring_assert( false !== strpos( $bootstrap, 'Version: 0.3.9' ) && false !== strpos( $bootstrap, "FALUSS_LINK_VERSION','0.3.9'" ), 'Faluss Link must expose the Studio polish patch as version 0.3.9.' );
