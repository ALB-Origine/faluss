...
studio_v1_wiring_assert( false !== strpos( $bootstrap, 'Version: 0.3.8' ) && false !== strpos( $bootstrap, "FALUSS_LINK_VERSION','0.3.8'" ), 'Faluss Link must expose the Studio wiring patch as version 0.3.8.' );
