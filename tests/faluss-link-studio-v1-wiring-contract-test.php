...
studio_v1_wiring_assert( false !== strpos( $bootstrap, 'Version: 0.3.11' ) && false !== strpos( $bootstrap, "FALUSS_LINK_VERSION','0.3.11'" ), 'Faluss Link must expose the Studio interaction patch as version 0.3.11.' );
