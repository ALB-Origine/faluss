...
onb026_assert( false !== strpos( $bootstrap, 'Version: 0.3.9' ) && false !== strpos( $bootstrap, "FALUSS_LINK_VERSION','0.3.9'" ), 'The current CSS and JavaScript assets need plugin version 0.3.9.' );
