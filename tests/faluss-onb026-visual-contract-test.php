...
onb026_assert( false !== strpos( $bootstrap, 'Version: 0.3.12' ) && false !== strpos( $bootstrap, "FALUSS_LINK_VERSION','0.3.12'" ), 'The current CSS and JavaScript assets need plugin version 0.3.12.' );
