...
final class Faluss_Subscriptions_Diagnostics {
    ...
    public static function status() {
        ...
        return array( 'schema' => Faluss_Subscriptions_Schema::get_status(), 'catalogue_version' => Faluss_Subscriptions_Catalog::VERSION, 'catalogue' => Faluss_Subscriptions_Catalog::plans(), 'counts' => $counts );
    }
}
