...
final class Token_Engine_Connector_Subject {
    ...
    public static function diagnostic() {
        ...
        return array(
            ...
            'identity_adapter_available' => class_exists( 'Faluss_Identity_Registry' ) && method_exists( 'Faluss_Identity_Registry', 'get_active_for_wp_user' ),
            'subject_available' => '' !== self::current(),
        );
    }
