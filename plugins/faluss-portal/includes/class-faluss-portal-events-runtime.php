...
final class Faluss_Portal_Events_Runtime {
    ...
    public static function register_runtime() {
        ...
        if ( ! self::is_local_hub()
            ...
            || ! method_exists( 'Faluss_Analytics', 'register_runtime' )
            || ! method_exists( 'Faluss_Analytics', 'runtime_state' )
        ...
        if ( ! Faluss_Analytics::register_runtime() ) {
